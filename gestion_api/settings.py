...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'lunaemilio2003@gmail.com'
EMAIL_HOST_PASSWORD = 'tpnmfybjdhrffjyk'
EMAIL_USE_TLS = True
...
DJOSER = {
    ...
    'SERIALIZERS': {
        'user_create': 'back.serializers.UserCreateSerializer',
        'user': 'back.serializers.UserCreateSerializer',
        'current_user': 'back.serializers.UserCreateSerializer',
